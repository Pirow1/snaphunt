...
export function ToastHost() {
  ...
  return (
    <div
      className={`pointer-events-none fixed bottom-[30px] left-1/2 z-[200] -translate-x-1/2 rounded-[2px] border-2 ${border} bg-carbon/95 px-4 py-2.5 font-display text-[16px] tracking-[0.08em] text-chalk backdrop-blur-md`}
      role="status"
      aria-live="polite"
    >
      {current.text}
