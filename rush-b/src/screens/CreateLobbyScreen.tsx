  ...
  return (
    <main className="flex h-full w-full flex-col bg-void text-smoke">
      <TopBar title="New Operation" back="/" right={
        <span className="rounded-[2px] border border-spark/40 bg-spark/10 px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.15em] text-spark">Host</span>
      } />

      <div className="flex flex-1 flex-col gap-7 overflow-y-auto px-5 py-6">
        <section>
          <label htmlFor="op-name" className="block font-mono text-[10px] uppercase tracking-[0.25em] text-ash mb-2">
            Operative Name
          </label>
          <input
            id="op-name"
          ...
          />
          <div className="mt-1 text-right font-mono text-[9px] text-ash">{trimmed.length}/24</div>
        </section>
        ...
        <div className="mt-auto">
          ...
          {!authUserId && (
            <p className="mt-2 text-center font-mono text-[9px] uppercase tracking-[0.15em] text-ash">
