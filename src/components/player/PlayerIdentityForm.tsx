...
export function PlayerIdentityForm({ variant, namePlaceholder, emojiOptions, onComplete, disabled }: Props) {
  ...
  const inputClass = isSnaphunt
    ? 'mt-2 w-full rounded-[3px] border-[1.5px] border-gold/25 bg-forest-mid px-4 py-3 font-mono text-lg tracking-wide text-parchment placeholder:text-parchment/40 focus:border-gold focus:bg-forest-rich focus:outline-none'
