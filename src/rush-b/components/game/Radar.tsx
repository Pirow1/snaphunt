...
export function Radar({ distanceMeters, accuracyMeters, targetLat, targetLng, pingFlash = false, timer = '' }: RadarProps) {
  ...
  return (
    ...
    >
      ...
      {/* HUD overlay */}
      <div className={`pointer-events-none absolute inset-0 z-20 flex flex-col justify-between p-3 font-rb-mono ${isClose ? 'text-threat' : 'text-gold'}`}>
        ...
        <div>
          <div
            className="text-center font-rb-mono text-[36px] font-bold tracking-tight"
          ...
          <div
            className={`text-center font-rb-display text-[12px] font-bold uppercase tracking-[0.15em] ${temp?.color ?? 'text-gold'}`}
