  ...
  return (
    <div className="rounded-[2px] border-2 border-rim bg-surface p-3">
      <div className="flex items-baseline justify-between mb-2">
        <span className="font-rb-mono text-[10px] uppercase tracking-[0.2em] text-ash">Bomb Location</span>
        <span className="font-rb-display text-[16px] text-spark">★ {pointValue} pts</span>
      </div>
      ...
      >
        {signedUrl ? (
          ...
          <div className="grid h-full w-full place-items-center font-rb-mono text-[10px] uppercase tracking-[0.25em] text-ash">
            awaiting plant…
          </div>
        )}
        <div className="absolute bottom-2 right-2 rounded-[2px] bg-void/90 px-2 py-0.5 font-rb-mono text-[9px] uppercase tracking-[0.12em] text-spark">
          {resolution}% res
        </div>
        {/* Corner brackets */}
