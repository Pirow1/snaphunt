...
export function SimonSaysPuzzle({ puzzle, onSolve, onFail }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-5">
      {phase === 'showing' ? (
        <p className="font-rb-display text-[14px] font-bold uppercase tracking-[0.15em] text-parchment/60">
          Watch the sequence…
        </p>
      ) : (
        <p className="font-rb-display text-[14px] font-bold uppercase tracking-[0.15em] text-gold">
