      ...
      <div className="flex flex-1 flex-col gap-3 px-5 pt-3 pb-5 overflow-y-auto">
        ...
        {compassNeedsPerm && (
          <button
            ...
            className="rounded-[2px] border-2 border-spark/60 bg-spark/10 py-2.5 font-rb-mono text-[11px] uppercase tracking-[0.15em] text-spark active:scale-[0.98]"
          >
            ↻ Enable Compass
          </button>
        )}
        ...
        {round.planter_lat !== null && round.planter_lng !== null ? (
          ...
          <div className="grid h-36 place-items-center rounded-[2px] border border-rim bg-surface font-rb-mono text-[10px] uppercase tracking-[0.2em] text-ash">
            awaiting bomb plant…
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-2.5 mt-auto">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-1 rounded-[2px] border border-rim bg-surface px-2 py-3 font-rb-mono text-[10px] uppercase tracking-[0.08em] text-smoke active:bg-spark/10 disabled:cursor-not-allowed disabled:opacity-40"
          >
          ...
          <PhotoCapture
            ...
            buttonProps={{
              className: 'flex items-center justify-center gap-2 rounded-[2px] border-none bg-threat px-4 py-3 font-rb-display text-[16px] text-chalk transition-[background,transform] active:scale-[0.97] disabled:opacity-40',
              disabled: submitting,
            }}
          >
          ...
          {submitError && (
            <div className="col-span-2 rounded-[2px] border border-threat/50 bg-threat/10 px-3 py-2 font-rb-mono text-[11px] text-threat">
              {submitError}
            </div>
          )}
        </div>
